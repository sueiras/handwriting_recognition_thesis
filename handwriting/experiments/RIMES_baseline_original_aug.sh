...
nohup python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/rimes/RIMES_baseline_original_aug_run01' \
    --data_path '/home/ubuntu/data/tesis/handwriting/databases/rimes/original' \
    ...
    --data_augmentation \
    --teacher_forcing \
    > RIMES_baseline_original_aug_run01.out &
