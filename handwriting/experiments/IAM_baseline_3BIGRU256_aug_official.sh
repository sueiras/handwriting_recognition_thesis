...
nohup python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/IAM/IAM_baseline_3BIGRU256_aug_official_run01' \
    --data_path '/home/jorge/data/tesis/handwriting/databases/IAM/official/words/normalized_all' \
    ...
    --data_augmentation \
    --teacher_forcing \
    > IAM_baseline_3BIGRU256_aug_official_run01.out &
