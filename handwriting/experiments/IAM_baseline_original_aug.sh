...
nohup python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/IAM/IAM_baseline_original_aug_run01' \
    --data_path '/home/jorge/data/tesis/handwriting/databases/IAM/aachen/words/original' \
    ...
    --data_augmentation \
    --teacher_forcing \
    > IAM_baseline_original_aug_run01.out &
