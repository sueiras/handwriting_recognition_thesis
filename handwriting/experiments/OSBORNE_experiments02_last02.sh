...
python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/osborne/osborne02_baseline_2BIGRU256_run02' \
    ...
    --teacher_forcing \
    > osborne02_baseline_2BIGRU256_run02.out
...
#OSBORNE_baseline_original_aug
python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/osborne/osborne02_baseline_original_aug_run01' \
    ...
    --data_augmentation \
    --no-teacher_forcing \
    > osborne02_baseline_original_aug_run01.out
