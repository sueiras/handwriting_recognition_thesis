...
nohup python ../tf1x/seq2seq_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/IAM/IAM_baseline_normSkew_run01' \
    --data_path '/home/jorge/data/tesis/handwriting/databases/IAM/aachen/words/normalized_slant' \
    ...
    --teacher_forcing \
    > IAM_baseline_normSkew_run01.out &
