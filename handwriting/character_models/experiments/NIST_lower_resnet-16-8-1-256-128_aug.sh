...
nohup python ../character_models_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/character/NIST/NIST_lower_resnet-16-8-1-256-128_aug_run01' \
    --dataset 'NIST' \
    ...
    --data_augmentation \
    > NIST_lower_resnet-16-8-1-256-128_aug_run01.out &
