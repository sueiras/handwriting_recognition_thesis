...
nohup python ../character_models_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/character/NIST/NIST_all_resnet-16-8-2-256-128_aug_run01' \
    --dataset 'NIST' \
    ...
    --data_augmentation \
    > NIST_all_resnet-16-8-2-256-128_aug_run01.out &
