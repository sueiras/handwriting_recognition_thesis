...
nohup python ../character_models_train.py \
    --experiment '/home/ubuntu/data/handwriting/experiments/character/NIST/NIST_upper_lenet-16-32-256-128_aug_run01' \
    --dataset 'NIST' \
    ...
    --data_augmentation \
    > NIST_upper_lenet-16-32-256-128_aug_run01.out &
